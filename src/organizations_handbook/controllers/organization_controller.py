...
from src.organizations_handbook.dependencies.organization_dependencies import (
    get_organization_service,
)
from src.organizations_handbook.exceptions.organization_exceptions import (
    OrganizationNotFound,
)
from src.organizations_handbook.schemas.organization_schema import (
    OrganizationSchema,
...
async def get_organization_by_name(
    ...
    try:
        return await organization_service.get_organization_by_name(
...
async def list_organizations_by_building(
    ...
    return await organization_service.list_organizations_by_building(
...
async def search_organizations_by_activity(
    ...
    return await organization_service.search_organizations_by_activity(
        activity=activity
    )
